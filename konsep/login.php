...
<body class="font-sans antialiased bg-gray-50 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-[400px]">
        ...
        <div class="text-center mb-6">
            <div class="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-gray-800 mb-3">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-5 border-b border-gray-200">
                <p class="text-xs font-semibold text-gray-500 mb-3">Quick Login (Akun Internal Staf)</p>
                <div class="grid grid-cols-3 gap-2">
                    <form method="POST"><input type="hidden" name="username" value="admin">
                        <button type="submit" class="w-full text-center p-2.5 rounded-xl border border-gray-200 bg-white hover:bg-gray-100 hover:border-gray-400 transition">
                            <span class="text-xs font-semibold text-gray-900 block">Super Admin</span>
                        </button>
                    </form>
            ...
            <div class="p-5">
                ...
                <form method="POST" class="space-y-3">
                    <div>
                        <label class="block text-xs font-medium text-gray-900 mb-1.5">Username Staf *</label>
                        <input type="text" name="username" required placeholder="admin / kasir_muharto"
                            class="w-full text-sm border border-gray-200 rounded-xl px-3.5 py-2.5 focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-500/10 bg-white transition">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-900 mb-1.5">Password *</label>
                        <input type="password" name="password" placeholder="••••••••"
                            class="w-full text-sm border border-gray-200 rounded-xl px-3.5 py-2.5 focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-500/10 bg-white transition">
                    </div>
                    <button type="submit"
                        class="w-full bg-gray-800 hover:bg-gray-700 text-white font-semibold text-sm py-2.5 rounded-xl transition mt-1">
                        Masuk ke Dashboard Operasional →
                    </button>
                </form>

                <div class="mt-4 pt-3 border-t border-gray-200 text-center text-xs text-gray-500">
                    Anda pembeli / pelanggan? <a href="zencare_store.php" class="font-semibold text-gray-800 hover:underline">Masuk ke E-Commerce</a>
                </div>
            </div>
        </div>

        <p class="text-center text-[11px] text-gray-500 mt-5">ZenCare Medical Omnichannel System v2.0</p>
    </div>
