    ...
    <div class="w-full max-w-[400px]">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="p-5 border-b border-gray-200 bg-slate-50">
                <p class="text-[11px] font-bold uppercase tracking-wider text-gray-500 mb-3 text-center">Quick Login (Demo Akun Pelanggan)</p>
                <form method="POST">
                    <input type="hidden" name="username" value="pelanggan1">
                    <input type="hidden" name="redirect" value="<?= htmlspecialchars($redirect) ?>">
                    <button type="submit" class="w-full text-center py-3 rounded-xl bg-white hover:bg-gray-100 text-gray-800 border border-gray-200 hover:border-gray-400 transition font-semibold text-xs shadow-sm">
                ...
                <form method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" required placeholder="••••••••" value="123456"
                            class="w-full text-xs border border-gray-200 rounded-xl px-4 py-3 bg-slate-50 focus:bg-white focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-500/20 transition placeholder-slate-400">
                        <p class="text-[10px] text-gray-500 mt-1.5 text-right"><a href="#" class="hover:text-gray-800 hover:underline">Lupa sandi?</a></p>
                    </div>
            ...
            <div class="p-5 border-t border-gray-200 bg-slate-50 text-center">
                <p class="text-xs text-gray-500 font-medium">Belum punya akun? <a href="register.php" class="text-gray-800 font-bold hover:underline">Daftar Sekarang</a></p>
            </div>
